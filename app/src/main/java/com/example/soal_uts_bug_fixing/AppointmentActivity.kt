...
//        memperbaiki isi ondateset
    ...
    override fun onTimeSet(p0: android.widget.TimePicker?, hour: Int, menit:Int) {
        timeInput = String.format("%02d:%02d", hour, menit) //ubah minute jadi menit
    ...
    override fun onDialogResult(result: Boolean) {
        ...
        val gender = intent.getStringExtra(FormActivity.EXTRA_GENDER)
            ...
            if (result) {
                ...
                // memperbaiki intentTOResult extra waktu dan tipe \\
...
//        tambah val year mothOfyear DayOFmonth
